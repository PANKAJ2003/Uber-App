...
const VehicleAvailableForRide = ({ setVehiclePanel, setConfirmRidePanel }) => {
  return (
    <div className=" bg-white p-3">
      ...
      <div className="flex gap-4 items-center border-2 active:border-black rounded-xl p-3 mb-2">
        ...
        <h2 className="font-semibold text-lg">₹105.34</h2>
      </div>
      <div className="flex gap-4 items-center border-2 active:border-black rounded-xl p-3 mb-2">
        ...
        <h2 className="font-semibold text-lg">₹223.34</h2>
      </div>
      <div className="flex gap-4 items-center border-2 active:border-black rounded-xl p-3 mb-2">
        <img className="h-12 w-12" src={bikeIcon} alt="bike" />
